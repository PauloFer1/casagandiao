...
<?php } ?>
        ...
        if($action != 'add')
        {
            if($page->id!=1)
            {
                $fstParent=Page::findById($page->parent_id);
                ...
                if($parent->id!=1 && $parent->id!=0)
                {
                    ...
                    echo("<h4 class='breadcrumbPage'>".$str."</h4>");
                    ...
                    else
                    {
                       ...
                       else
                       {
                           echo('<div id="pageTitle">
                           <p class="button buttonLeft">
                                <a  href="'.URL_PUBLIC.ADMIN_DIR.'/plugin/modulos?modulo='.$parent->id.'&it='.$fstParent->id.'"><img src="'.URL_PUBLIC.ADMIN_DIR.'/images/return_btn.png"/><span class="buttonText"> VOLTAR A '.strtoupper($fstParent->title).'</span></a>
                            </p>
                            </div>');
                       }
                    }
    ...
    <div id="tab-control-meta" class="tab_control">
        ...
        <div id="meta-pages" class="pages">
            <div id="div-title" class="title" title="<?php echo __('Page Title'); ?>">
              <input class="textbox required" id="page_title" maxlength="255" name="page[title]" size="255" type="text" value="<?php echo $page->title; ?>" />
              <span id='page_title_msg' class='requiredMsg'><? echo(__('Mandatory Field')); ?></span>
...
<script type="text/javascript">
    ...
    document.title = "tarabackend- <? echo($page->title); ?>";
</script>