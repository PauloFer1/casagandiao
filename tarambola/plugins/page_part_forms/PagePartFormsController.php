...
class PagePartFormsController extends PluginController {
    ...
    const PROPERTY_MAXSIZE ="maxsize";
    ...
    public static function Init() {
        ...
        Plugin::addJavascript(self::PLUGIN_ID, "page_part_forms.js");
        ...
        foreach ($user_structure as $structure_element_name => $structure_element) {
            ...
            switch ($element[self::PROPERTY_TYPE]) {
                case self::TYPE_SELECT:
                     if (isset($structure_element[self::PROPERTY_VALIDATION])) {
                        $element[self::PROPERTY_VALIDATION][] = ($structure_element[self::PROPERTY_VALIDATION]);
                    }
                    if (isset($structure_element[self::PROPERTY_TRANSLATION])) {
                        $element[self::PROPERTY_TRANSLATION][] = ($structure_element[self::PROPERTY_TRANSLATION]);
                    }
                    // Get values
                ...
                case self::TYPE_IMAGE:
                    ...
                    if (isset($structure_element[self::PROPERTY_MAXSIZE])) {
                        $element[self::PROPERTY_MAXSIZE][] = ($structure_element[self::PROPERTY_MAXSIZE]);
                    } else {
                        // Ignore this elementg
                        continue 2; // XXX: PHP is strange!
                    }
                ...
                case self::TYPE_TABLE:
                 ...
                 case self::TYPE_ATTRIBUTES:
                    ...
                    // Limit selection
                    self::Array_get_set($structure_element, $element, self::PROPERTY_LIMIT, 2000);
                    break;
                 case self::TYPE_DRAW:
                     if (isset($structure_element[self::PROPERTY_TRANSLATION])) {
                        $element[self::PROPERTY_TRANSLATION][] = ($structure_element[self::PROPERTY_TRANSLATION]);
                        ...
                        {  
                            if ($p->id == $key ) {
                                if($flag==0)
                                   ...
                                   $flag=0;
                                $t=$key+$inc+$flag;
                                if ($form = PageMetadata::FindOneByPageAndKeyword($key + $inc+$flag, self::PLUGIN_ID)) {
