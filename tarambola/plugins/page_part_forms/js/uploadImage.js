 ...
 function initUploader(url, btn, container, structId, maxSize){
    var btn = jQuery('#'+btn);
    var uploader = new ss.SimpleUpload({
      button: btn, // HTML element used as upload button
      url: url+'tarambola/plugins/page_part_forms/scripts/UploadImage.php', // URL of server-side upload handler
      ...
      onComplete:   function(filename, response) {
          if(jQuery('#page_title').val()=="") jQuery('#page_title').val("INSERT TITLE HERE");
          if (!response.success) {
