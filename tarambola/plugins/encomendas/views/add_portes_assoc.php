<h1><?php echo __('Adicionar Unidade máxima'); ?></h1>
    ...
    <div id="Page-part-forms-Form">
        <div class="page-part-forms-row">
                ...
                <div class="page-part-forms-input">
                    <input type="text" maxlength="255" value="" name="nome_user" class="page-part-forms-part-text" id="unidadeMaxInput">        
                </div> 
        </div>
         <div class="page-part-forms-row">
        ...
        <div class="page-part-forms-row">
                ...
                <button class="saveFrontUserBtn" onclick="insertPortesAssoc('<? echo(URL_PUBLIC); ?>')">  salvar </button>
        </div>
    </div>
</div>